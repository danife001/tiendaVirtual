                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form action="../../controller/insertProd.php" method="POST" enctype="multipart/form-data">
                                            <div class="row">
                                            <div class="mb-3 col-md-4">
                      <label for="serie " class="form-label">numero de serie </label>
                      <input type="number" class="form-control" id="serie" name="serie"  placeholder="Ej: 1.085.454.277">
                      </div>

                        
                        <div class="mb-3 col-md-4">
                          <label for="nombreP" class="form-label">Nombre del producto</label>
                          <input type="text" class="form-control" id="nombreP" required name="nombreP" placeholder="Ej: computador">
                        </div>

                        <div class="mb-3 col-md-4">
                          <label for="fotoP" class="form-label">foto del producto</label>
                          <input type="file" class="form-control"  required name="fotoP" accept=".jpg, .png, .jpeg, .gif">
                          <small> tamaño maximo 2mb </small>
                        </div>

                          <div class="mb-3 col-md-4">
                            <label for="precio" class="form-label">precio</label>
                            <input type="number" class="form-control" id="precio" required name="precio"  placeholder="Ej: 100000">
                          </div>

                            <div class="mb-3 col-md-4">
                              <label for="descrip" class="form-label">descripcion</label>
                              <input type="text" class="form-control" id="descrip" required name="descrip"  placeholder="Ej: pepejunior@example.com">
                            </div>
                            <div class="mb-3 col-md-4">
                            <label for="cantidad" class="form-label">cantidad</label>
                            <input type="number" class="form-control" id="cantidad" required name="cantidad"  placeholder="Ej: 10">
                          </div>
